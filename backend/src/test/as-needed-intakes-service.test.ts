...
describe.sequential("as-needed intake service", () => {
	...
	it("records topical applications without changing measurable stock", async () => {
	...
	it.skip("keeps legacy reversal and replacement mutation coverage out of the public Undo contract", async () => {
