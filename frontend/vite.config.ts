...
const requestedHmrProtocol = process.env.VITE_HMR_PROTOCOL;
const hmrProtocol = requestedHmrProtocol === "ws" || requestedHmrProtocol === "wss" ? requestedHmrProtocol : undefined;
