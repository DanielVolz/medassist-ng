...
export type PlannerUnitKind = "pills" | "ml" | "units" | "puffs" | "injections";

export type PackageProfile = {
	value: PackageType;
	labelKey: string;
	amountBased: boolean;
	plannerUnitKind: PlannerUnitKind;
...
export function getPlannerUnitKind(packageType?: string | null): PlannerUnitKind {
	return getPackageProfile(packageType).plannerUnitKind;
}
